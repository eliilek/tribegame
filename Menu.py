...
class Menu():
    ...
    def __init__(self, image, items, funcs, font = None, font_size = 30, font_color = (255, 255, 255)):
        screen = pygame.image.load(image)
        self.screen = pygame.transform.scale(screen, (pygame.display.get_surface().get_width(), pygame.display.get_surface().get_height()))
